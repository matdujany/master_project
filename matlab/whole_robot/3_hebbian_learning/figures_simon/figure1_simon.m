...
legend_list_dot_time = {['Motor ' num2str(idx_motor) ' filt and diff'],...
               ...
               strcat(txt_channel_acc{1,idx_channel_acc}, ' filtered'),...
...
plot(time_plot_diff,data_acc_filtered_rescaled(2:end),'Color',color_list(4,:),'LineStyle','--','LineWidth',lineWidth);
