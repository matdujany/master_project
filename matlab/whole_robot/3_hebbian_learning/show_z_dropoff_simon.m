...
for i=1:4
    data_lc{i} = data.float_value_time{1,i}(index_start:index_end,3);
end
...
x_patch_dropoff = [825 1050 1050 825];
y_patch_dropoff = [-1 -1 4 4];

%% figure

manual_grid_values = [0]; 
...
lgd.Position = [0.1527,0.6267,0.139,0.3171];
ax = gca;
